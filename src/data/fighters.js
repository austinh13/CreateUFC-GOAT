...
export const FIGHTER_POOL = {
  "Men's Flyweight": [
    ...
    F('Amir Albazi', 'current', 'B', 'C+', 'B+', 'A-', 'B', 'B-'),
    F('Alex Perez', 'current', 'B', 'B-', 'B+', 'B', 'B', 'B-'),
    F('Zhalgas Zhumagulov', 'current', 'B-', 'C+', 'B', 'B-', 'B', 'C+'),
    F('Charles Johnson', 'current', 'C+', 'C', 'B-', 'C+', 'B-', 'C'),
    F('Zarrukh Adashev', 'current', 'C', 'C-', 'B-', 'C+', 'C+', 'C'),
  ],
  "Men's Bantamweight": [
    ...
    F('Montel Jackson', 'current', 'B+', 'B-', 'B', 'C+', 'B', 'B+'),
    F('Said Nurmagomedov', 'current', 'B-', 'B-', 'B+', 'A-', 'B+', 'B-'),
    F('Cody Stamann', 'current', 'B', 'B-', 'B+', 'B-', 'B', 'B'),
    F('John Dodson', 'legend', 'B+', 'B+', 'C+', 'C', 'B', 'B-'),
    F('Cody Garbrandt', 'current', 'B', 'B+', 'C', 'C', 'C+', 'C-'),
    F('Randy Costa', 'current', 'C+', 'C', 'C', 'C', 'C+', 'C'),
  ],
  "Men's Featherweight": [
    ...
    F('Bryce Mitchell', 'current', 'C+', 'C', 'B+', 'A-', 'B+', 'B'),
    F('Darren Elkins', 'legend', 'C+', 'B-', 'B', 'B-', 'B+', 'B+'),
    F('Kyle Nelson', 'current', 'B-', 'B-', 'B', 'B', 'B', 'B'),
    F('Julian Erosa', 'current', 'C+', 'C', 'C', 'B-', 'C+', 'B-'),
    F('Gavin Tucker', 'current', 'C+', 'C', 'C', 'C+', 'C', 'C+'),
  ],
  "Men's Lightweight": [
    ...
    F('Beneil Dariush', 'current', 'B', 'B', 'B', 'B+', 'B', 'B-'),
    F('Grant Dawson', 'current', 'B', 'C+', 'B+', 'B+', 'B+', 'B-'),
    F('Jared Gordon', 'current', 'C+', 'C', 'B-', 'C+', 'B-', 'B-'),
    F('Fares Ziam', 'current', 'C', 'C-', 'B-', 'C', 'C', 'C+'),
  ],
  "Men's Welterweight": [
    ...
    F('Alex Morono', 'current', 'B-', 'B-', 'B', 'B-', 'B', 'B'),
    F('Themba Gorimbo', 'current', 'B', 'B+', 'C+', 'C', 'B-', 'B-'),
    F('Nicolas Dalby', 'current', 'C+', 'C', 'B-', 'B-', 'C+', 'C'),
    F('Yohan Lainesse', 'current', 'C+', 'C', 'C', 'C-', 'C', 'C'),
  ],
  "Men's Middleweight": [
    ...
    F('Brendan Allen', 'current', 'C+', 'C+', 'B+', 'A-', 'B', 'B-'),
    F('Cody Brundage', 'current', 'C', 'C-', 'B-', 'C+', 'C', 'C+'),
    F('Punahele Soriano', 'current', 'B-', 'B', 'C-', 'D+', 'C-', 'C'),
  ],
  "Men's Light Heavyweight": [
    ...
    F('Magomed Ankalaev', 'current', 'B', 'B-', 'A-', 'B-', 'A-', 'B+'),
    F('Aleksandar Rakić', 'current', 'A-', 'B+', 'B', 'C+', 'B-', 'B'),
    F('Nikita Krylov', 'current', 'B-', 'B', 'B', 'A-', 'B', 'C+'),
    F('Ryan Spann', 'current', 'B', 'B+', 'B-', 'B', 'C+', 'C+'),
    F('Zac Pauga', 'current', 'C', 'C', 'C+', 'C-', 'C', 'C+'),
  ],
  "Men's Heavyweight": [
    F('Jon Jones', 'both', 'A', 'A', 'A+', 'B+', 'A-', 'A-'),
    ...
    F('Alexander Volkov', 'current', 'B+', 'B', 'C+', 'C+', 'B', 'C+'),
    F('Marcos Rogério de Lima', 'current', 'B-', 'A-', 'C', 'B+', 'C+', 'C+'),
    F('Shamil Abdurakhimov', 'legend', 'B', 'B+', 'C+', 'C+', 'C+', 'B-'),
    F('Josh Parisian', 'current', 'C', 'C', 'C-', 'C', 'C', 'C+'),
  ],
  "Women's Strawweight": [
    ...
    F('Amanda Lemos', 'current', 'B+', 'A-', 'C+', 'B+', 'B', 'B'),
    F('Loopy Godinez', 'current', 'B-', 'C+', 'B', 'B+', 'B', 'B'),
    F('Iasmin Lucindo', 'current', 'B-', 'B-', 'B', 'B', 'B', 'B-'),
    F('Vanessa Demopoulos', 'current', 'C+', 'C', 'B', 'B+', 'B', 'B-'),
    F('Emily Ducote', 'current', 'C+', 'C', 'C', 'C+', 'C+', 'C'),
    F('Elise Reed', 'current', 'C', 'C-', 'C+', 'C', 'C', 'C+'),
  ],
  "Women's Flyweight": [
    ...
    F('Erin Blanchfield', 'current', 'B-', 'C+', 'A-', 'A', 'B+', 'B'),
    F('Gillian Robertson', 'current', 'C+', 'C', 'B', 'A', 'B', 'B+'),
    F('Melissa Gatto', 'current', 'C+', 'C', 'B', 'B+', 'B', 'B'),
    F('JJ Aldrich', 'current', 'B-', 'B-', 'B', 'B-', 'B', 'B'),
    F('Priscila Cachoeira', 'current', 'C', 'C', 'C+', 'C', 'C-', 'C+'),
    F('Miranda Maverick', 'current', 'C+', 'C', 'B-', 'C+', 'B-', 'C'),
  ],
  "Women's Bantamweight": [
    ...
    F('Mayra Bueno Silva', 'current', 'B-', 'C+', 'B', 'A-', 'B+', 'B'),
    F('Ailín Pérez', 'current', 'B', 'B+', 'C+', 'C+', 'B', 'B-'),
    F('Pannie Kianzad', 'current', 'B', 'B', 'B-', 'B-', 'B', 'B-'),
    F('Wu Yanan', 'current', 'C+', 'C+', 'B+', 'B-', 'B', 'B'),
    F('Josiane Nunes', 'current', 'C+', 'C', 'C', 'C+', 'C', 'C-'),
    F('Julia Avila', 'current', 'C', 'C', 'C+', 'C-', 'C', 'C+'),
  ],
};
